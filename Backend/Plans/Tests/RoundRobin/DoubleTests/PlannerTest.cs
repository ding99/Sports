...
public class PlannerTest {
    ...
    public void UpdateListTest_Team2_Player0() {
        ...
        oa.Court.Team1.Players.Should().HaveCount(2);
        oa.Court.Team2.Players.Should().HaveCount(1);
        oa.Court.Team2.Players[0].Should().Be(5);
    ...
    public void UpdateListTest_Team2_Player1() {
        ...
        oa.Tour.Rounds[2].Courts[0].Team2.Players[1].Should().Be(2);

        oa.Round.Courts.Should().HaveCount(0);

        oa.Court.Team1.Players.Should().HaveCount(0);
        oa.Court.Team2.Players.Should().HaveCount(0);
